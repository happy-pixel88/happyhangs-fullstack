...
export default function CheckoutPage() {
 ...
 const pkCities = [
  ...
  // All figures drawn strictly from Medusa's computed cart object
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <div className="border-2 border-black p-5 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sticky top-6 space-y-6">
